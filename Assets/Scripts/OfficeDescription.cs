...
public class OfficeDescription : MonoBehaviour
{
    ...
    public void setText()
    {
        fullText[0] = "Hey, Welcome in Pitch Office";
        fullText[1] = "Pitch your idea click on Pitch Idea Button";
        fullText[2] = "Then submit your idea, and get reward points";
    }
